import 'dart:async'; // ✅ 1. เพิ่ม import เพื่อให้ใช้งาน Timer ได้
...
class _HomePageState extends State<HomePage> {
  ...
  Timer? _refreshTimer; // ✅ 2. ย้ายตัวแปร Timer มาไว้ที่นี่
  ...
  @override
  void dispose() {
    _refreshTimer?.cancel(); // ✅ 4. ยกเลิก Timer เมื่อปิดหน้า
    super.dispose();
  }
